...
class SpearmanSoldierTest extends TestCase
{
    public function testFailWithEmptyArrayAttributes()
    {
        try {
            $soldier = new SpearmanSoldier([]);
        } catch (\Exception $e) {
    ...
    public function testSuccessWithAllRequiredAttributes()
    {
        ...
        $this->assertSame('spearman', $soldier->getAbility());
        $this->assertSame('mediumDistance', $soldier->getTypeBattle());
    }
}
